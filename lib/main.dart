  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MultiBlocProvider(
        providers: [
          BlocProvider<UserBloc>(create: (context) => UserBloc()..add(CheckStoredUser())),
          BlocProvider<AppartementBloc>(create: (context) => AppartementBloc()),
          BlocProvider<ReservationBloc>(create: (context) => ReservationBloc()),
        ...
        child: SimpleWebSocketInitializer(
          child: MaterialApp.router(
            ...
            builder: (context, child) => FavoriteSnackBarHandler(child: child!),
          ),
        ),
      ),
    );
